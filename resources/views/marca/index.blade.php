...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{ route('marcas.create') }}"><button type="button" class="btn btn-primary">Crear nueva
                marca</button></a>
    </div>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal"
                                    data-bs-target="#confirmModal-{{ $marca->id }}">Inactivar</button>
                                @else
                                <button type="button" class="btn btn-success rounded" data-bs-toggle="modal"
                                    data-bs-target="#confirmModal-{{ $marca->id }}">Activar</button>
                                @endif
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $marca->caracteristica->estado == 1 ? '¿Seguro que quieres inactivar la marca?' :
                                    '¿Seguro que quieres activar la marca?' }}
                                </div>
