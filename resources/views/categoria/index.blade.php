                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal"
                                    data-bs-target="#confirmModal-{{ $categoria->id }}">Inactivar</button>
                                @else
                                <button type="button" class="btn btn-success rounded" data-bs-toggle="modal"
                                    data-bs-target="#confirmModal-{{ $categoria->id }}">Activar</button>
                                @endif
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $categoria->caracteristica->estado == 1 ? '¿Esta seguro de inactivar esta
                                    categoría?' : '¿Esta seguro de activar esta categoría?' }}
                                </div>
