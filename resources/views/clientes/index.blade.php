...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{ route('clientes.create') }}"><button type="button" class="btn btn-primary">Crear nuevo
                cliente</button></a>
    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        {{ $item->persona->estado == 1 ? '¿Seguro que quieres inactivar el cliente?' : '¿Seguro que quieres
                                        activar el cliente?' }}
                                    </div>
